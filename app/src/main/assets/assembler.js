...
function assemble(parsed, context) {
  ...
  for (const node of parsed.children) {
    ...
    if (/^address$/i.test(node.text))
      ...
      else machineCode[address].hex += "0";
      machineCode[address].hex += node.children[0].registerNumber(
      ...
      else machineCode[address].hex += "6";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].registerNumber(context.namedRegisters) === "none")
      ...
      if (node.children[2].text === "()") machineCode[address].hex += "e";
      else machineCode[address].hex += "f";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].text === "()") {
        ...
        if (
          node.children[2].children[0].registerNumber(
            context.namedRegisters
          ) === "none"
        ) {
          alert(
            "Line #" +
              node.lineNumber +
              ': "' +
              node.children[2].children[0].text +
              '" is not a register!'
          );
          return;
        }
        machineCode[address].hex +=
          node.children[2].children[0].registerNumber(context.namedRegisters) +
          "0";
      } else
        machineCode[address].hex += formatAsByte(
          node.children[2].interpretAsArithmeticExpression(context.constants)
      ...
      machineCode[address].line = node.lineNumber;
      machineCode[address].hex = "0";
      if (node.children[2].text === "()") machineCode[address].hex += "a";
      else machineCode[address].hex += "b";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].text === "()") {
      ...
      machineCode[address].line = node.lineNumber;
      machineCode[address].hex = "0";
      if (node.children[2].text === "()") machineCode[address].hex += "8";
      else machineCode[address].hex += "9";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].text === "()") {
      ...
      machineCode[address].line = node.lineNumber;
      machineCode[address].hex = "2";
      if (node.children[2].text === "()") machineCode[address].hex += "c";
      else machineCode[address].hex += "d";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].text === "()") {
      ...
      if (
        ...
        alert(
          "Line #" +
            node.lineNumber +
            ": '" +
            node.children[0].children[2].text +
            "' is not a register name!"
        );
        return;
      }
      ...
      machineCode[address].line = node.lineNumber;
      if (!node.children.length) machineCode[address].hex = "25000";
      ...
      else machineCode[address].hex += "2";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].registerNumber(context.namedRegisters) === "none")
      ...
      else machineCode[address].hex += "8";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].registerNumber(context.namedRegisters) === "none")
      ...
      else machineCode[address].hex += "a";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].registerNumber(context.namedRegisters) === "none")
      ...
      else machineCode[address].hex += "c";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].registerNumber(context.namedRegisters) === "none")
      ...
      else machineCode[address].hex += "e";
      machineCode[address].hex += node.children[0].registerNumber(
        context.namedRegisters
      );
      if (node.children[2].registerNumber(context.namedRegisters) === "none")
